      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="stat-card">
          <div className="flex justify-between items-center border-b border-mu-border pb-2">
            <h3 className="text-mu-gold/90 font-medieval">Totais</h3>
          ...
          <div className="space-y-1 pt-2">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{formatNumber(stats.total.resets)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Soul:</span>
              <span className="font-medium">{formatNumber(stats.total.soul)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">MR:</span>
              <span className="font-medium">{formatNumber(stats.total.mr)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="stat-card">
          <div className="flex justify-between items-center border-b border-mu-border pb-2">
            <h3 className="text-mu-gold/90 font-medieval">Média por Hora</h3>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-mu-gold/70" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="stat-card">
          <div className="flex justify-between items-center border-b border-mu-border pb-2">
            <h3 className="text-mu-gold/90 font-medieval">Média Diária</h3>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-mu-gold/70" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="stat-card">
          <div className="flex justify-between items-center border-b border-mu-border pb-2">
            <h3 className="text-mu-gold/90 font-medieval">Média Semanal</h3>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-mu-gold/70" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
